---
name: azure
description: Handle Azure management tasks including viewing logs, deployment status, and executing Azure CLI commands
---
...
### 1. No arguments or "status" - Show deployment overview:
...
### 2. "logs" or "logs api" - Show API logs:
